...
protocol RandomCocktailViewModelProtocol: AnyObject {
    var randomCocktail: RandomCocktail? { get }
    func fetchRandomCocktail(completion: @escaping (Result<RandomCocktail, NetworkError>) -> Void)
}

final class RandomCocktailViewModel: RandomCocktailViewModelProtocol {
