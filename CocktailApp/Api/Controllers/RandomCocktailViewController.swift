...
class RandomCocktailViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        // SwiftUI ekranını burada göstereceğiz
        setupSwiftUI()
    }

    private func setupSwiftUI() {
        let swiftUIView = RandomCocktailSwiftUIView(viewModel: viewModel)
        let hostingController = UIHostingController(rootView: swiftUIView)
        
        // HostingController'ı ekliyoruz
...
//import SDWebImageSwiftUI // SDWebImage'in SwiftUI uyumlu versiyonu
